...
const PlantDetail = ({ navigation }) => {
        ...
        return (
            ...
            >
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <TouchableOpacity
                        style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center',marginTop:"-150%" }}
                ...
                <View style={{ flexDirection: 'row', marginTop: "5%" }}>
                    <View style={{ flex: 1 }}>
                        <Text style={{ color: COLORS.white, ...FONTS.largeTitle }}>Chăm sóc cây</Text>
                    </View>
    ...
    function renderFooter() {
        return (
            <View style={{ flex: 1, flexDirection: 'row', paddingVertical: SIZES.padding }}>
                ...
                >
                    <Text style={{ color: COLORS.white, ...FONTS.h2 }}>Bấm</Text>
                ...
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: SIZES.padding }}>
                    <Text style={{ flex: 1, color: COLORS.secondary, ...FONTS.h3 }}>do something</Text>
                    <Image
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <Text style={{ paddingHorizontal: SIZES.padding, color: COLORS.secondary, ...FONTS.h1 }}>Yêu cầu</Text>
